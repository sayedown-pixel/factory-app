...
# ============================================================================
# 9. تحميل وحفظ المنتج التام (finished_goods.xlsx)
# ============================================================================
...
def main():
    ...
    st.sidebar.divider()
    st.sidebar.markdown(f"<center><small>BIRMA v22.0<br>{t['designer']}</small></center>", unsafe_allow_html=True)
