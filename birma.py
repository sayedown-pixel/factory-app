...
LANG = {
    "ar": {
        ...
        "password": "كلمة المرور", "login_btn": "دخول", "login_error": "خطأ", "logout": "تسجيل خروج",
        "welcome": "مرحباً", "role": "الدور", "dark_mode": "الوضع الليلي", "dashboard": "🏠 لوحة القيادة",
        "production": "📈 إدارة الإنتاج", "maintenance": "🔧 مركز الصيانة", "records": "📊 السجلات",
        "raw_materials": "📦 المخازن (مواد خام)", "finished_goods": "🏭 مخزن الإنتاج التام",
        "users": "👥 المستخدمين", "settings": "⚙️ الإعدادات", "line_label": "خط العمل",
        "sup_label": "المشرف", "prod_label": "المنتج", "target_label": "الكمية",
        "preform_label": "البريفورم المستخدم", "raw_label": "خامة التغليف", "date_label": "التاريخ",
        "maint_header": "مركز الصيانة", "maint_types": ["صيانة دورية", "بلاغ عطل"],
        "tech_label": "الفني", "issue_label": "وصف العطل", "start_t": "بداية التوقف",
        "end_t": "نهاية الإصلاح", "note_label": "ملاحظات", "save_btn": "حفظ",
        "success_msg": "تم الحفظ بنجاح", "eff_title": "متوسط الكفاءة", "waste_title": "تحليل الهالك",
        "history_p": "سجل الإنتاج", "history_m": "سجل الصيانة", "admin_title": "لوحة التحكم - حذف السجل",
        "delete_btn": "حذف السجل المختار", "del_success": "تم حذف السجل بنجاح",
        "tools_label": "الأدوات:", "proc_label": "الإجراءات:", "weekend_msg": "الجمعة عطلة",
        "inventory_header": "إدارة المخازن", "current_stock": "المخزون الحالي", "receipt": "استلام مشتريات",
        "alerts": "تنبيهات", "material": "المادة", "quantity": "الكمية", "invoice": "رقم الفاتورة",
        "receipt_date": "تاريخ الاستلام", "register_receipt": "تسجيل الاستلام", "low_stock_alert": "مواد منخفضة",
        "all_good": "جميع المواد آمنة", "edit_stock": "تعديل الرصيد", "new_stock": "الرصيد الجديد",
        "update": "تحديث", "stock_updated": "تم تحديث الرصيد", "export_btn": "تصدير",
        "dashboard_title": "لوحة القيادة", "total_production": "إجمالي الإنتاج", "avg_efficiency": "متوسط الكفاءة",
        "total_waste": "إجمالي الهالك", "low_stock_count": "مواد خام منخفضة", "line1_efficiency": "كفاءة الخط الأول",
        "line2_efficiency": "كفاءة الخط الثاني", "smart_recommendations": "التوصيات الذكية",
        "users_title": "إدارة المستخدمين", "settings_title": "إعدادات النظام", "backup_data": "نسخ احتياطي",
        "clear_cache": "مسح الذاكرة", "machine_select": "اختر الماكينة", "task_name": "المهمة",
        "done": "تم التنفيذ", "no_data": "لا توجد بيانات", "no_production": "لا توجد سجلات إنتاج",
        "no_maintenance": "لا توجد سجلات صيانة", "add_new_item": "إضافة صنف جديد", "item_id": "الرقم",
        "item_name": "اسم المادة", "item_unit": "الوحدة", "min_stock": "الحد الأدنى",
        "info_title": "معلومات", "info_text": "حفظ البيانات على هذا الجهاز فقط", "shipping": "شحن منتجات",
        "customer": "اسم العميل", "register_shipping": "تسجيل الشحن", "balance": "الرصيد",
        "in": "وارد", "out": "صادر", "pallet_count": "عدد الباليتات", "last_10_days": "آخر 10 أيام",
        "remember_me": "تذكرني على هذا الجهاز", "clear_saved": "مسح البيانات المحفوظة"
    },
    "en": {
        "designer": "Eng. Elsayed Aoun", "login_title": "Login", "username": "Username",
        "password": "Password", "login_btn": "Login", "login_error": "Error", "logout": "Logout",
        "welcome": "Welcome", "role": "Role", "dark_mode": "Dark Mode", "dashboard": "🏠 Dashboard",
        "production": "📈 Production", "maintenance": "🔧 Maintenance", "records": "📊 Records",
        "raw_materials": "📦 Raw Materials", "finished_goods": "🏭 Finished Goods", "users": "👥 Users",
        "settings": "⚙️ Settings", "line_label": "Line", "sup_label": "Supervisor", "prod_label": "Product",
        "target_label": "Quantity", "preform_label": "Preforms Used", "raw_label": "Packaging",
        "date_label": "Date", "maint_header": "Maintenance", "maint_types": ["Planned", "Breakdown"],
        "tech_label": "Technician", "issue_label": "Issue", "start_t": "Start", "end_t": "End",
        "note_label": "Notes", "save_btn": "Save", "success_msg": "Saved", "eff_title": "Efficiency",
        "waste_title": "Waste", "history_p": "Production Logs", "history_m": "Maintenance Logs",
        "admin_title": "Admin - Delete", "delete_btn": "Delete Record", "del_success": "Deleted",
        "tools_label": "Tools:", "proc_label": "Procedure:", "weekend_msg": "Friday weekend",
        "inventory_header": "Inventory", "current_stock": "Current Stock", "receipt": "Receive",
        "alerts": "Alerts", "material": "Material", "quantity": "Quantity", "invoice": "Invoice",
        "receipt_date": "Date", "register_receipt": "Register", "low_stock_alert": "Low Stock",
        "all_good": "All Good", "edit_stock": "Edit Stock", "new_stock": "New Stock",
        "update": "Update", "stock_updated": "Updated", "export_btn": "Export",
        "dashboard_title": "Dashboard", "total_production": "Total Production", "avg_efficiency": "Avg Efficiency",
        "total_waste": "Total Waste", "low_stock_count": "Low Raw Materials", "line1_efficiency": "Line 1 Efficiency",
        "line2_efficiency": "Line 2 Efficiency", "smart_recommendations": "Smart Recommendations",
        "users_title": "Users", "settings_title": "Settings", "backup_data": "Backup", "clear_cache": "Clear Cache",
        "machine_select": "Select Machine", "task_name": "Task", "done": "Done", "no_data": "No data",
        "no_production": "No production", "no_maintenance": "No maintenance", "add_new_item": "Add Item",
        "item_id": "ID", "item_name": "Name", "item_unit": "Unit", "min_stock": "Min Stock",
        "info_title": "Info", "info_text": "Data saved on this device only", "shipping": "Shipping",
        "customer": "Customer", "register_shipping": "Register", "balance": "Balance", "in": "In",
        "out": "Out", "pallet_count": "Pallets", "last_10_days": "Last 10 Days",
        "remember_me": "Remember me", "clear_saved": "Clear saved"
    },
    "bn": {
        "designer": "ইঞ্জি. সাঈদ আউন", "login_title": "লগইন", "username": "ব্যবহারকারীর নাম",
        "password": "পাসওয়ার্ড", "login_btn": "লগইন", "login_error": "ভুল", "logout": "লগআউট",
        "welcome": "স্বাগতম", "role": "ভূমিকা", "dark_mode": "ডার্ক মোড", "dashboard": "🏠 ড্যাশবোর্ড",
        "production": "📈 উৎপাদন", "maintenance": "🔧 রক্ষণাবেক্ষণ", "records": "📊 রেকর্ড",
        "raw_materials": "📦 কাঁচামাল", "finished_goods": "🏭 সমাপ্ত পণ্য", "users": "👥 ব্যবহারকারী",
        "settings": "⚙️ সেটিংস", "line_label": "লাইন", "sup_label": "সুপারভাইজার", "prod_label": "পণ্য",
        "target_label": "পরিমাণ", "preform_label": "প্রিফর্ম", "raw_label": "প্যাকেজিং", "date_label": "তারিখ",
        "maint_header": "রক্ষণাবেক্ষণ", "maint_types": ["পরিকল্পিত", "ব্রেকডাউন"], "tech_label": "টেকনিশিয়ান",
        "issue_label": "সমস্যা", "start_t": "শুরু", "end_t": "শেষ", "note_label": "নোট", "save_btn": "সংরক্ষণ",
        "success_msg": "সংরক্ষিত", "eff_title": "দক্ষতা", "waste_title": "বর্জ্য", "history_p": "উৎপাদন লগ",
        "history_m": "রক্ষণাবেক্ষণ লগ", "admin_title": "অ্যাডমিন - মুছুন", "delete_btn": "রেকর্ড মুছুন",
        "del_success": "মুছে ফেলা হয়েছে", "tools_label": "সরঞ্জাম:", "proc_label": "পদ্ধতি:",
        "weekend_msg": "শুক্রবার ছুটি", "inventory_header": "ইনভেন্টরি", "current_stock": "বর্তমান স্টক",
        "receipt": "গ্রহণ", "alerts": "সতর্কতা", "material": "উপাদান", "quantity": "পরিমাণ",
        "invoice": "ইনভয়েস", "receipt_date": "তারিখ", "register_receipt": "নিবন্ধন", "low_stock_alert": "স্বল্প স্টক",
        "all_good": "সব ঠিক", "edit_stock": "স্টক সম্পাদনা", "new_stock": "নতুন স্টক", "update": "আপডেট",
        "stock_updated": "আপডেট হয়েছে", "export_btn": "এক্সপোর্ট", "dashboard_title": "ড্যাশবোর্ড",
        "total_production": "মোট উৎপাদন", "avg_efficiency": "গড় দক্ষতা", "total_waste": "মোট বর্জ্য",
        "low_stock_count": "স্বল্প কাঁচামাল", "line1_efficiency": "লাইন ১ দক্ষতা", "line2_efficiency": "লাইন ২ দক্ষতা",
        "smart_recommendations": "স্মার্ট সুপারিশ", "users_title": "ব্যবহারকারী", "settings_title": "সেটিংস",
        "backup_data": "ব্যাকআপ", "clear_cache": "ক্যাশ সাফ", "machine_select": "মেশিন নির্বাচন",
        "task_name": "কাজ", "done": "সম্পন্ন", "no_data": "তথ্য নেই", "no_production": "উৎপাদন রেকর্ড নেই",
        "no_maintenance": "রক্ষণাবেক্ষণ রেকর্ড নেই", "add_new_item": "আইটেম যোগ করুন", "item_id": "আইডি",
        "item_name": "নাম", "item_unit": "ইউনিট", "min_stock": "ন্যূনতম স্টক", "info_title": "তথ্য",
        "info_text": "ডেটা শুধুমাত্র এই ডিভাইসে সংরক্ষিত", "shipping": "প্রেরণ", "customer": "গ্রাহক",
        "register_shipping": "প্রেরণ নিবন্ধন", "balance": "ব্যালেন্স", "in": "ইন", "out": "আউট",
        "pallet_count": "প্যালেট", "last_10_days": "শেষ ১০ দিন", "remember_me": "মনে রাখুন",
...
# ============================================================================
# 8. مخزن المواد الخام (raw.xlsx) - حفظ محلي
# ============================================================================
RAW_MATERIALS_FILE = "raw.xlsx"

def load_raw_materials():
    """تحميل بيانات المخزون من الملف المحلي raw.xlsx"""
...
def create_default_raw_materials():
    """إنشاء ملف مخزون افتراضي"""
    default_data = {
        "Material_ID": [1001, 1002, 1003, 1004, 1005],
        "Material_Name_AR": ["بريفورم 200 مل", "بريفورم 330 مل", "غطاء", "كرتون", "شرنك"],
        "Current_Stock": [500000, 300000, 1000000, 50000, 5000],
        "Min_Stock": [100000, 50000, 200000, 10000, 1000],
...
def update_raw_materials(df_raw):
    """تحديث بيانات المخزون في الملف المحلي"""
    try:
...
# ============================================================================
# 9. BOM والمواد المضافة (تم تعديل 331 إلى 330)
# ============================================================================
CONFIG = {
    "الخط الأول(smi)": {
    ...
    "الخط الثاني(welbing)": {
        "products": ["200 ml Carton", "200 ml Shrink", "330 ml Carton", "330 ml Shrink"],  # تم تعديل 331 إلى 330
...
BOM = {
    ...
    "330 ml Shrink": {"بريفورم330": 20, "غطاء": 20, "ليبل 330": 20, "شرنك330": 0.0005},  # تم تعديل 331 إلى 330
}

SHRINK_PALLET_CONFIG = {
    "200 ml Shrink": {"units_per_pallet": 180, "spacers_per_pallet": 7},
    "330 ml Shrink": {"units_per_pallet": 144, "spacers_per_pallet": 5},  # تم تعديل 331 إلى 330
...
ADHESIVE_CONSUMPTION = {
    ...
    "1.5 L Shrink": 0.35, "330 ml Carton": 0.35, "330 ml Shrink": 0.35,  # تم تعديل 331 إلى 330
}
...
def get_materials_required(product, quantity):
    """حساب المواد المطلوبة للإنتاج (دون تغيير المخزون)"""
...
def restore_materials(product, quantity, df_raw):
    """إعادة المواد إلى المخزون (عند حذف سجل إنتاج)"""
    required, error = get_materials_required(product, quantity)
    if error:
        return df_raw, False, error
...
def load_finished_goods():
    """تحميل بيانات مخزن الإنتاج التام من الملف المحلي"""
    if os.path.exists(FINISHED_GOODS_FILE):
        try:
            ...
            rename_map = {
                ...
                'number of pallet': 'Pallet_Count'
            }
            for old, new in rename_map.items():
                if old in df.columns:
                    df = df.rename(columns={old: new})
            
            required_cols = ["Code", "Name", "In", "Out", "Balance", "Unit", "Pallet_Count"]
            for col in required_cols:
            ...
            for col in ["Code", "In", "Out", "Balance", "Pallet_Count"]:
                if col in df.columns:
                    df[col] = pd.to_numeric(df[col], errors='coerce').fillna(0)
            
            # إعادة حساب الباليتات للتأكد
            for idx, row in df.iterrows():
                product_name = row["Name"] if pd.notna(row["Name"]) else ""
                balance = row["Balance"] if pd.notna(row["Balance"]) else 0
                unit = row["Unit"] if pd.notna(row["Unit"]) else ""
                df.at[idx, "Pallet_Count"] = calculate_pallet_count(product_name, balance, unit)
            ...
            return create_default_finished_goods()
    else:
        return create_default_finished_goods()

def create_default_finished_goods():
    """إنشاء ملف مخزن إنتاج تام افتراضي"""
    default_data = {
        "Code": [200, 330, 600, 201, 202, 350],
        "Name": ["Cartoon 200 ml", "Cartoon 330 ml", "Cartoon 600 ml", 
                 "Shrink 200 ml", "Shrink 330 ml", "1.5 Ltr"],
        "In": [0, 0, 0, 0, 0, 0],
        "Out": [0, 0, 0, 0, 0, 0],
        "Balance": [0, 0, 0, 0, 0, 0],
        "Unit": ["Carton", "Carton", "Carton", "Shrink", "Shrink", "Shrink"],
        "Pallet_Count": [0, 0, 0, 0, 0, 0],
        "Last_Updated": [datetime.now().strftime("%Y-%m-%d")] * 6
    }
    df_default = pd.DataFrame(default_data)
    df_default.to_excel(FINISHED_GOODS_FILE, index=False)
    return df_default

def update_finished_goods(df):
    """تحديث بيانات مخزن الإنتاج التام في الملف المحلي"""
    try:
        # إعادة حساب الباليتات قبل الحفظ
        for idx, row in df.iterrows():
            product_name = row["Name"] if pd.notna(row["Name"]) else ""
            balance = row["Balance"] if pd.notna(row["Balance"]) else 0
            unit = row["Unit"] if pd.notna(row["Unit"]) else ""
        ...
        df.to_excel(FINISHED_GOODS_FILE, index=False)
        return True
    except Exception as e:
...
def restore_finished_goods(product_name, quantity, df_fg):
    """إعادة منتج تام من المخزن (عند حذف سجل الإنتاج)"""
    mapping = {
        "200 ml Carton": "Cartoon 200 ml",
        "200 ml Shrink": "Shrink 200 ml",
        "600 ml Carton": "Cartoon 600 ml",
    ...
    return df_fg, True, f"✅ تم حذف {quantity:,.0f} وحدة من المخزن"
...
def translate_dataframe(df, lang):
    ...
    trans = {
        "ar": {"Date": "التاريخ", "Line": "الخط", "Supervisor": "المشرف", "Product": "المنتج",
               ...
               "Preforms_Used": "البريفورم المستخدم"},
        ...
        "bn": {"Date": "তারিখ", "Line": "লাইন", "Supervisor": "সুপারভাইজার", "Product": "পণ্য",
               ...
               "Preforms_Used": "প্রিফর্ম ব্যবহৃত"}
    }
    rename = {col: trans.get(lang, trans["ar"]).get(col, col) for col in df.columns}
    return df.rename(columns=rename)

def save_backup(df_main, df_raw, df_fg):
    """حفظ نسخة احتياطية من جميع البيانات"""
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    
    if df_main is not None and not df_main.empty:
        df_main.to_excel(f"backup_main_{timestamp}.xlsx", index=False)
    if df_raw is not None and not df_raw.empty:
        df_raw.to_excel(f"backup_raw_{timestamp}.xlsx", index=False)
    if df_fg is not None and not df_fg.empty:
        df_fg.to_excel(f"backup_fg_{timestamp}.xlsx", index=False)
    
    return f"تم إنشاء نسخة احتياطية ({timestamp})"
...
def main():
                    ...
                    if not raw_ok:
                        ...
                        if update_raw_materials(new_raw):
                            ...
                            new_row = pd.DataFrame([{
                                ...
                                "Waste_Bottles": int(preforms - (target * packs)) if preforms > 0 else 0,
                            ...
                            # إضافة المنتج إلى مخزن الإنتاج التام
                            if not df_fg.empty:
    ...
    # ========== Settings ==========
        ...
        with col1:
            if st.button(t["backup_data"], use_container_width=True):
                backup_msg = save_backup(df_main, df_raw, df_fg)
    ...
    with st.sidebar.expander("🔒 " + t["admin_title"]):
        if st.text_input(t["password"], type="password", key="del_pw") == "admin123":
                ...
                if 'Type' in df_display.columns and 'Date' in df_display.columns:
                    ...
                    if st.button("🗑️ " + t["delete_btn"], use_container_width=True):
                        ...
                        if selected_row['Type'] == 'Production':
                            ...
                            # إزالة المنتج من مخزن الإنتاج التام
                            if not df_fg.empty:
                                new_fg, fg_ok, fg_msg = restore_finished_goods(product_name, quantity, df_fg)
                                if fg_ok:
                                    update_finished_goods(new_fg)
                                    st.info(fg_msg)
                            ...
                            # حذف السجل من Google Sheets
                            df_updated = df_main.drop(selected_idx)
            ...
            if st.session_state.get('del_pw', ''):
                st.warning("🔒 كلمة المرور غير صحيحة")
    
    st.sidebar.divider()
    st.sidebar.markdown(f"<center><small>BIRMA v12.2<br>{t['designer']}</small></center>", unsafe_allow_html=True)
