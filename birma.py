...
# --- 2. نظام اللغات (مع إضافة البنجالية) ---
if 'lang' not in st.session_state:
    st.session_state.lang = 'ar'

ln = st.sidebar.selectbox("🌐 Language / اللغة / ভাষা", ["ar", "en", "bn"], index=0)
...
LANG = {
    ...
    "bn": {
        ...
        "menu": ["📈 উৎপাদন ব্যবস্থাপনা", "🔧 রক্ষণাবেক্ষণ কেন্দ্র", "📊 রেকর্ড ও রিপোর্ট", "📦 ইনভেন্টরি ব্যবস্থাপনা"],
        "line_label": "উৎপাদন লাইন",
        "sup_label": "সুপারভাইজারের নাম",
        "prod_label": "পণ্যের ধরন",
        "target_label": "উৎপাদনের পরিমাণ (ইউনিট)",
        "preform_label": "ব্যবহৃত প্রিফর্ম (পিস)",
        "raw_label": "ব্যবহৃত প্যাকেজিং উপকরণ",
        "date_label": "শিফটের তারিখ",
        "maint_header": "🛠 রক্ষণাবেক্ষণ কেন্দ্র",
        "maint_types": ["পরিকল্পিত রক্ষণাবেক্ষণ", "ব্রেকডাউন রিপোর্ট"],
        "tech_label": "টেকনিশিয়ানের নাম",
        "issue_label": "সমস্যার বিবরণ",
        "start_t": "বন্ধের শুরু",
        "end_t": "মেরামতের শেষ",
        "note_label": "অতিরিক্ত নোট",
        "save_btn": "সংরক্ষণ ও বিজ্ঞপ্তি পাঠান",
        "success_msg": "✅ সফলভাবে সংরক্ষিত ও বিজ্ঞপ্তি পাঠানো হয়েছে",
        "eff_title": "গড় দক্ষতা %",
        "waste_title": "ঐতিহাসিক বর্জ্য বিশ্লেষণ",
        "history_p": "উৎপাদন লগ",
        ...
        "tools_label": "🔧 সরঞ্জাম:",
        "proc_label": "📜 কাজের মান/পরিষ্কার:",
        "weekend_msg": "🏖 আজ শুক্রবার (সাপ্তাহিক ছুটি) - কোন পরিকল্পিত রক্ষণাবেক্ষণ নেই।",
        "inventory_header": "📦 ইনভেন্টরি ব্যবস্থাপনা",
        "current_stock": "📋 বর্তমান স্টক",
        "receipt": "➕ উপকরণ গ্রহণ",
        "alerts": "⚠️ স্টক সতর্কতা",
        "material": "উপাদান",
        "quantity": "পরিমাণ",
        "invoice": "ইনভয়েস নম্বর",
        "receipt_date": "গ্রহণের তারিখ",
        "register_receipt": "গ্রহণ নিবন্ধন",
        "low_stock_alert": "⚠️ নিম্নলিখিত উপাদানগুলি ন্যূনতম সীমার নিচে:",
        "all_good": "✅ সমস্ত উপাদান ন্যূনতম সীমার উপরে",
        "edit_stock": "✏️ ম্যানুয়াল স্টক সমন্বয় (শুধু অ্যাডমিন)",
        "new_stock": "নতুন স্টক মান",
        "update": "আপডেট",
        "password": "পাসওয়ার্ড",
        "shortage_error": "⚠️ উপাদানের ঘাটতি: ",
        "stock_updated": "স্টক সফলভাবে আপডেট হয়েছে",
        "receipt_log": "গ্রহণ লগ",
        "view_logs": "📋 লেনদেন লগ"
    }
}
...
# --- 5. تحميل بيانات المخزون (نسخة معدلة) ---
def load_inventory():
...
def update_inventory(df_inv):
    ...
    numeric_cols = ["Current_Stock", "Min_Stock", "Max_Stock", "Unit_Cost"]
...
def calculate_required_materials(product, quantity_produced, df_bom):
    """حساب كميات المواد المطلوبة للإنتاج"""
...
def consume_materials(product, quantity_produced, df_inv, df_bom):
    """صرف المواد الأولية من المخزون (نسخة معدلة)"""
    ...
    # التأكد من أن Last_Updated من نوع نص
    if 'Last_Updated' in new_df.columns:
...
# --- تذييل الصفحة ---
st.markdown(f"<br><hr><center><p style='color: gray;'>BIRMA v8.0 | <b>Designed by: {LANG[ln]['designer']}</b></p></center>", unsafe_allow_html=True)